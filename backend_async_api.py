...
async def create_upload_batch_from_url(background_tasks: BackgroundTasks, files: List[FileCallbackItem]):
    """
...
async def generate_titles_endpoint(req: GenerateTitlesRequest, background_tasks: BackgroundTasks):
    """
    提供给前端/业务端的独立接口：
